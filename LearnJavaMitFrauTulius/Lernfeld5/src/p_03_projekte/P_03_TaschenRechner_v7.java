...
public class P_03_TaschenRechner_v7 extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
        	P_03_TaschenRechner_v7 calculator = new P_03_TaschenRechner_v7();
