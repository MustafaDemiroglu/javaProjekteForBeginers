...
public class P_03_Calculator_Professional extends JFrame implements ActionListener {
    private JTextField textField;
    private double firstNumber;
    private String operator;

    public P_03_Calculator_Professional() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new P_03_Calculator_Professional());
    }
}